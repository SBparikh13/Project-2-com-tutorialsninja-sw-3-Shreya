...
//        if(driver.findElement(By.xpath("//div[@class='collapse navbar-collapse navbar-ex1-collapse'])[1]")).equals(menu)){
//            mouseClickOnElement(By.xpath("//a[normalize-space()='Desktops']"));
//            verifyText(By.xpath("(//a[normalize-space()='Show AllDesktops'])[1]"),"Show All Desktops");
//        }else{
//            System.out.println("You have selected wrong menu");
//        }
//
//
//        }
