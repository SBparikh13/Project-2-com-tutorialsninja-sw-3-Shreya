...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.name("firstname"), "Param");
        //3.4 Enter Last Name
        sendTextToElement(By.name("lastname"), "Parikh");
        //3.5 Enter Email
        sendTextToElement(By.name("email"), "pbp22@gmail.com");
        //3.6 Enter Telephone
        sendTextToElement(By.name("telephone"), "987654321");
       //3.7 Enter Password
        sendTextToElement(By.id("input-password"), "Beta234");
       //3.8 Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "Beta234");
   ...
   // 3.17 Click on Continue button
    ...
    //4.3 Enter Email address
        sendTextToElement(By.id("input-email"), "pbp22@gmail.com");
    //4.5 Enter Password
        sendTextToElement(By.name("password"), "Beta234");
